...
export interface Sub_categoryBase {
  ID?: number;
  Title: string;
  "Category#Id"?: number;
  Remarks?: string;
...
export interface Sub_categoryRead extends Sub_categoryBase {
  Category: CategoryValue;
  Editor?: EditorValue;
  Author?: AuthorValue;
}

export interface Sub_categoryWrite extends Sub_categoryBase {
  Category: CategoryValue;
  Editor?: EditorValue;
  Author?: AuthorValue;
}
